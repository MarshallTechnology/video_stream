...
import com.marshalltechnology.video_stream.CameraPermissions.PermissionsRegistry;
...
final class MethodCallHandlerImpl implements MethodChannel.MethodCallHandler {
    ...
    MethodCallHandlerImpl(
        ...
        methodChannel = new MethodChannel(messenger, "video_stream/camera");
        imageStreamChannel = new EventChannel(messenger, "video_stream/camera/imageStream");
