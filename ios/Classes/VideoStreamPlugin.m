...
+ (void)registerWithRegistrar:(NSObject<FlutterPluginRegistrar> *)registrar {
  FlutterMethodChannel *channel =
      [FlutterMethodChannel methodChannelWithName:@"video_stream/camera"
...
- (void)initDeviceEventMethodChannel {
  _deviceEventMethodChannel =
      [FlutterMethodChannel methodChannelWithName:@"video_stream/cameraPlugin/device"
...
- (void)handleMethodCallAsync:(FlutterMethodCall *)call result:(FlutterResult)result {
  if ([@"availableCameras" isEqualToString:call.method]) {
    ...
    if ([@"initialize" isEqualToString:call.method]) {
      ...
      __weak VideoStreamPlugin *weakSelf = self;
      _camera.onFrameAvailable = ^{
        [weakSelf.registry textureFrameAvailable:cameraId];
      };
      FlutterMethodChannel *methodChannel = [FlutterMethodChannel
          methodChannelWithName:[NSString stringWithFormat:@"video_stream/cameraPlugin/camera%lu",
